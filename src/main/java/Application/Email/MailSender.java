...
public class MailSender {
    ...
    private static final String USERNAME = "vmd.duckie@yandex.ru";
    private static final String PASSWORD = "verymagicduck";
    private static final String EMAIL_FROM = "vmd.duckie@yandex.ru";
